...
public class LifecycleServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		//	첫 호출시 init 메소드가 수행됨 : 서블릿 초기화 담당
		System.out.println("Lifecycle : init()");
	}
	
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//	요청이 들어올 때 호출, 요청 방식에 따라 doGet or doPost 호출
		//	요청 메소드 방식에 관계 없이 호출된다
...
//		resp.setContentType("text/html;charset=UTF-8");
		...
		out.println("<li>dburl : " + dburl + "</li>");	//	li : list item
	...
	@Override
	public void destroy() {
		//	서버가 중단되거나 오랜 시간 서블릿 요청이 없을 때 -> 서블릿의 자원 정리
